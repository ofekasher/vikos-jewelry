    ...
    <footer style={{ background: "#0A0A0A", color: "#fff" }}>
      ...
      >
        ...
        <div>
          ...
          <p style={{
            ...
            fontSize: "13px", fontWeight: 300, color: "rgba(255,255,255,0.5)",
            lineHeight: 1.8, maxWidth: "210px", marginBottom: "32px",
          }}>
            תכשיטים מעוצבים ביד בישראל. כל פריט מספר סיפור.
          </p>
          ...
          <div style={{ display: "flex", borderBottom: "1px solid rgba(255,255,255,0.2)", paddingBottom: "10px", gap: "8px" }}>
            ...
            <button style={{
              ...
              color: "#C9A96E", whiteSpace: "nowrap", padding: 0,
            }}>
              הצטרף →
            </button>
          </div>
      ...
      <div style={{ maxWidth: "1160px", margin: "0 auto", padding: "20px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <p style={{ fontFamily: "'Inter',sans-serif", fontSize: "10px", color: "rgba(255,255,255,0.25)", margin: 0 }}>
          © {new Date().getFullYear()} Vikos Jewelry. כל הזכויות שמורות.
        </p>
